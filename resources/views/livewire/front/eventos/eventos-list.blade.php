        ...
        <section id="eventos" class="pb-5">
            <div class="row">
                <div class="col-sm-12 text-end">
                    <a href="{{route('eventos.old')}}" class="btn btn-lg btn-outline-dark"><i class="fa-solid fa-arrow-rotate-left"></i> Ver
                        Eventos Pasados</a>
                </div>
                ...
                @else
                    <h3 class="text-center">Por El Momento No Hay Eventos Próximos </h3>
