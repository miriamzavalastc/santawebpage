    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table wire:sortable="updateBannerOrder" id="kt_datatable_horizontal_scroll"
                                    ...
                                    <td style="max-width: 130px;">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-400 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('sistema.noticias.edit', $d->id) }}"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#"
                                                    wire:click="$emit('deleteNoticias',{{ $d->id }})"
                        ...
                        @else
                            <tr>
                                <td colspan="6" class="text-center">
                                    ...
                                    <br>
                                    <a href="{{ route('sistema.noticias.create') }}" class="btn btn-dark">Registrar
                                        una Noticia</a>
                                </td>
                            </tr>
...
@push('js')
    ...
    <script>
        ...
        Livewire.on('deleteNoticias', dataID => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.emit('deleteNoticia', dataID);
                    Swal.fire({
                        title: 'Eliminado',
                        confirmButtonColor: '#212529',
                        icon: 'success',
