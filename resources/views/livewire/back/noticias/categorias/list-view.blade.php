                                    ...
                                    <td style="max-width: 130px;">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-400 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('sistema.noticias.categoria.show', $d->id) }}"
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ route('sistema.noticias.categoria.edit', $d->id) }}"
                                                    class="menu-link px-3">
                                                    Editar
                                                </a>
                                            </div>
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#"
                                                    wire:click="$emit('btndeleteNoticiasCategoria',{{ $d->id }})"
                        ...
                        @else
                            <tr>
                                <td colspan="6" class="text-center">
                                    ...
                                    <br>
                                    <a href="{{ route('sistema.noticias.categoria.create') }}"
                                        class="btn btn-dark">Registrar
                                        una
                                        Categoria de Noticias</a>
                                </td>
                            </tr>
...
@push('js')
    ...
    <script>
        ...
        Livewire.on('btndeleteNoticiasCategoria', dataID => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.emit('deleteNoticiasCategoria', dataID);
                    Swal.fire({
                        title: 'Eliminado',
                        confirmButtonColor: '#212529',
                        icon: 'success',
