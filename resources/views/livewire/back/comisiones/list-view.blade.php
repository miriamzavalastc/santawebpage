...
<div>
    <div class="row mb-10 pt-6">
        ...
        <div class="col-sm-12 col-md-4">
            <div class="mb-5">
                <label for="search_comision" class="form-label">Comisión</label>
                <input type="text" class="form-control" wire:model.defer="search_comision" id="search_comision"
                    placeholder="Comisión..." />
            </div>
        </div>
        <div class="col-sm-12 col-md-4">
            <div class="mb-5">
                <label for="search_presidente" class="form-label">Presidente</label>
                <input type="text" class="form-control" wire:model.defer="search_presidente" id="search_presidente"
                    placeholder="Presidente..." />
            </div>
        </div>
        <div class="col-sm-12 col-md-4">
            <div class="mb-5">
                <label for="search_tipo" class="form-label">Tipo</label>
                <select name="search_tipo" id="search_tipo" wire:model.defer="search_tipo" class="form-select">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table wire:sortable="updateComisionOrder"  id="kt_datatable_horizontal_scroll" class="table table-striped table-row-bordered gy-5 gs-7">
                                    ...
                                    <td style="max-width: 130px;">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-400 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('sistema.comisiones.show', $d->id) }}"
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ route('sistema.comisiones.edit', $d->id) }}"
                                                    class="menu-link px-3">
                                                    Editar
                                                </a>
                                            </div>
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="#" wire:click="$emit('deleteComisiones',{{$d->id}})" data-kt-subscriptions-table-filter="delete_row"
                                                    class="menu-link px-3">
                                                    Eliminar
                                                </a>
                                            </div>
                        ...
                        @else
                            <tr>
                                <td colspan="6" class="text-center">
                                    ...
                                    <br>
                                    <a href="{{ route('sistema.comisiones.create') }}" class="btn btn-dark">Registrar
                                        una
                                        Comisión</a>
                                </td>
                            </tr>
...
<script>
    ...
    Livewire.on('deleteComisiones', dataID => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Livewire.emit('deleteComision', dataID);
            Swal.fire({
                title: 'Eliminado',
                confirmButtonColor: '#212529',
                icon: 'success',
