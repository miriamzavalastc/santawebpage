                                    ...
                                    <td style="max-width: 130px;">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-400 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('sistema.tramites.top.edit', $d->id) }}"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#"
                                                    wire:click="$emit('deleteServicioTopBtn',{{ $d->id }})"
                        ...
                        @else
                            <tr>
                                <td colspan="6" class="text-center">
                                    ...
                                    <br>
                                    <a href="{{ route('sistema.tramites.top.create') }}" class="btn btn-dark">Registrar
                                        un Servicio TOP
                                        </a>
                                </td>
                            </tr>
...
@push('js')
    ...
    <script>
        ...
        Livewire.on('deleteServicioTopBtn', dataID => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.emit('deleteServicioTop', dataID);
                    Swal.fire({
                        title: 'Eliminado',
                        confirmButtonColor: '#212529',
                        icon: 'success',
