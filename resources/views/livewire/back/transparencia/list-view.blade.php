                        ...
                        @if (count($data) > 0)
                            @foreach ($data as $d)
                                <tr  >
                                    ...
                                    <td>{{ $d->nombre }}</td>
                                    <td><a class="" href="{{$d->link}}" target="_blank">{{$d->link}}</a></td>
                                    ...
                                    <td style="max-width: 130px;">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-400 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('sistema.transparencia.edit', $d->id) }}"
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="#" wire:click="$emit('deleteTrans',{{$d->id}})" data-kt-subscriptions-table-filter="delete_row"
                                                    class="menu-link px-3">
                                                    Eliminar
                                                </a>
                                            </div>
                        ...
                        @else
                            <tr>
                                <td colspan="4" class="text-center">
                                    ...
                                    <br>
                                    <a href="{{ route('sistema.transparencia.create') }}" class="btn btn-dark">Registrar
                                        un Link
                                        </a>
                                </td>
                            </tr>
...
<script>
    ...
    Livewire.on('deleteTrans', dataID => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Livewire.emit('deleteTransparencia', dataID);
            Swal.fire({
                title: 'Eliminado',
                confirmButtonColor: '#212529',
                icon: 'success',
