    ...
    <div class="row mb-10 pt-6">
        ...
        <div class="col-sm-12 col-md-4">
            <div class="mb-5">
                ...
                <input type="text" class="form-control" wire:model.defer="search_secretaria" id="search_secretaria"
                                    ...
                                    <td style="max-width: 130px;">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-400 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('sistema.dependencia.show', $d->id) }}"
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ route('sistema.dependencia.edit', $d->id) }}"
                                                    class="menu-link px-3">
                                                    Editar
                                                </a>
                                            </div>
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="#" wire:click="$emit('deleteDepend',{{$d->id}})" data-kt-subscriptions-table-filter="delete_row"
                                                    class="menu-link px-3">
                                                    Eliminar
                                                </a>
                                            </div>
                        ...
                        @else
                            <tr>
                                <td colspan="6" class="text-center">
                                    ...
                                    <br>
                                    <a href="{{ route('sistema.dependencia.create') }}" class="btn btn-dark">Registrar
                                        una
                                        Dependencia</a>
                                </td>
                            </tr>
...
<script>
    ...
    Livewire.on('deleteDepend', dataID => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Livewire.emit('deleteDependencias', dataID);
            Swal.fire({
                title: 'Eliminado',
                confirmButtonColor: '#212529',
                icon: 'success',
