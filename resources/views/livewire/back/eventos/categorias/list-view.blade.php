                        ...
                        @if (count($data) > 0)
                            @foreach ($data as $d)
                                <tr >
                                    ...
                                    <td>{{ $d->nombre }}</td>
                                    <td>
                                        <div style="background-color:  {{ $d->color }}; padding:5px 10px;">
                                        {{ $d->color }}
                                        </div>
                                    </td>
                                    <td>
                                        @if ($d->icono)
                                            <img src="{{ asset($d->icono) }}" alt="{{ $d->nombre }}" style="max-width: 100px;">
                                        @else
                                            -
                                        @endif
                                    </td>
                                    ...
                                    <td style="max-width: 130px;">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-400 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('sistema.eventos.categoria.show', $d->id) }}"
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ route('sistema.eventos.categoria.edit', $d->id) }}"
                                                    class="menu-link px-3">
                                                    Editar
                                                </a>
                                            </div>
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#"
                                                    wire:click="$emit('deleteCategoriasEventos',{{ $d->id }})"
                        ...
                        @else
                            <tr>
                                <td colspan="6" class="text-center">
                                    ...
                                    <br>
                                    <a href="{{ route('sistema.eventos.categoria.create') }}"
                                        class="btn btn-dark">Registrar
                                        una
                                        Categoria de Evento</a>
                                </td>
                            </tr>
...
@push('js')
    ...
    <script>
        ...
        Livewire.on('deleteCategoriasEventos', dataID => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.emit('deleteCategoriaEvento', dataID);
                    Swal.fire({
                        title: 'Eliminado',
                        confirmButtonColor: '#212529',
                        icon: 'success',
